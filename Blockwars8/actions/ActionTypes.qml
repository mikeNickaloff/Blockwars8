...
KeyTable {
    ...
    property string powerupEnergyDelta: "powerupEnergyDelta"
    property string powerupEnergyReset: "powerupEnergyReset"
    property string powerupReadyState: "powerupReadyState"
    property string deployPowerupRequest: "deployPowerupRequest"
    property string deployPowerupApplied: "deployPowerupApplied"
    property string executePowerupAbility: "executePowerupAbility"
    property string applyPowerupBlocksEffect: "applyPowerupBlocksEffect"
    property string applyPowerupCardHealth: "applyPowerupCardHealth"
    property string powerupPlayerHealthDelta: "powerupPlayerHealthDelta"
